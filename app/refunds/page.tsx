...
export default function RefundsPage() {
  return (
    <LegalPage eyebrow="Customer policy" title="Refund policy" lead="We want every eSIM to work as described. This policy explains when a digital plan can be cancelled, replaced or refunded.">
      <section><h2>1. Before activation</h2><p>You may request cancellation within 14 days of purchase when the eSIM has not been activated, installed or used and no mobile data has been consumed. Eligibility is confirmed using the technical status supplied by the eSIM platform. Mandatory consumer rights remain unaffected.</p></section>
      ...
      <section><h2>6. Chargebacks</h2><p>Please contact us before starting a payment dispute so we have an opportunity to deliver or fix the service. This does not prevent you from using any rights available through your bank, Paddle or applicable law.</p></section>
    </LegalPage>
  );
}
