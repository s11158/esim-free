...
export const MESSAGES: Record<Language, Messages> = {
  en: {
    ...
    statPlans: "plans available", statCountries: "popular destinations", statMarkup: "affiliate redirects",
  ...
  ru: {
    ...
    statPlans: "доступных тарифов", statCountries: "популярных стран", statMarkup: "партнёрских переадресаций",
  ...
  es: {
    ...
    statPlans: "planes disponibles", statCountries: "destinos populares", statMarkup: "redirecciones afiliadas",
  ...
  fr: {
    ...
    statPlans: "forfaits disponibles", statCountries: "destinations populaires", statMarkup: "redirections affiliées",
  ...
  de: {
    ...
    statPlans: "verfügbare Tarife", statCountries: "beliebte Reiseziele", statMarkup: "Affiliate-Weiterleitungen",
  ...
  pt: {
    ...
    statPlans: "planos disponíveis", statCountries: "destinos populares", statMarkup: "redirecionamentos afiliados",
  ...
  ar: {
    ...
    statPlans: "باقة متاحة", statCountries: "وجهة شائعة", statMarkup: "تحويلات تسويقية",
  ...
  tr: {
    ...
    statPlans: "mevcut paket", statCountries: "popüler ülke", statMarkup: "iş ortaklığı yönlendirmesi",
  ...
  zh: {
    ...
    statPlans: "种套餐可选", statCountries: "个热门目的地", statMarkup: "联盟跳转",
  ...
  ja: {
    ...
    statPlans: "以上のプラン", statCountries: "の人気渡航先", statMarkup: "外部購入リンク",
  ...
  ko: {
    ...
    statPlans: "개 이상의 요금제", statCountries: "개 인기 여행지", statMarkup: "제휴 구매 이동",
  ...
  hi: {
    ...
    statPlans: "प्लान उपलब्ध", statCountries: "लोकप्रिय गंतव्य", statMarkup: "एफिलिएट रीडायरेक्ट",
