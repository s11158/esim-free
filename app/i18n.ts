...
export const MESSAGES: Record<Language, Messages> = {
  en: {
    ...
    heroLead: "Choose a destination. Esim.free sells affordable prepaid eSIM plans directly, with clear prices and direct support.", findEsim: "Find an eSIM",
    ...
    faqEyebrow: "The essentials", questions: "Questions", faqIntro: "Straight answers without fine print or marketing fog.", choosePlan: "Choose a plan",
    faq: [
  ...
  es: {
    ...
    faqEyebrow: "Lo esencial", questions: "Preguntas", faqIntro: "Respuestas claras, sin letra pequeña ni humo comercial.", choosePlan: "Elegir un plan",
    faq: [
  ...
  fr: {
    ...
    faqEyebrow: "L’essentiel", questions: "Questions", faqIntro: "Des réponses claires, sans petites lignes ni jargon marketing.", choosePlan: "Choisir un forfait",
    faq: [
  ...
  de: {
    ...
    faqEyebrow: "Kurz erklärt", questions: "Fragen", faqIntro: "Klare Antworten ohne Kleingedrucktes und Marketingnebel.", choosePlan: "Tarif wählen",
    faq: [
  ...
  pt: {
    ...
    faqEyebrow: "O essencial", questions: "Dúvidas", faqIntro: "Respostas claras, sem letras miúdas ou enrolação de marketing.", choosePlan: "Escolher plano",
    faq: [
  ...
  ar: {
    ...
    faqEyebrow: "المهم باختصار", questions: "الأسئلة", faqIntro: "إجابات واضحة بلا حروف صغيرة أو عبارات تسويقية.", choosePlan: "اختر باقة",
    faq: [
  ...
  tr: {
    ...
    faqEyebrow: "Kısaca", questions: "Sorular", faqIntro: "Küçük yazılar ve pazarlama karmaşası olmadan net yanıtlar.", choosePlan: "Paket seç",
    faq: [
  ...
  zh: {
    ...
    faqEyebrow: "重要信息", questions: "常见问题", faqIntro: "没有小字条款，也没有营销话术，只有清晰答案。", choosePlan: "选择套餐",
    faq: [
  ...
  ja: {
    ...
    offers: "{count} 件", providerPurchase: "Esim.freeが販売・サポート", dataLabel: "データ", durationLabel: "有効期間", best: "最安", choose: "選ぶ",
    ...
    faqEyebrow: "知っておきたいこと", questions: "よくある質問", faqIntro: "小さな文字や曖昧な広告表現のない、明確な回答です。", choosePlan: "プランを選ぶ",
    faq: [
  ...
  ko: {
    ...
    offers: "{count}개 상품", providerPurchase: "Esim.free가 판매 및 지원", dataLabel: "데이터", durationLabel: "유효기간", best: "최저가", choose: "선택",
    ...
    faqEyebrow: "핵심 정보", questions: "자주 묻는 질문", faqIntro: "작은 글씨나 마케팅 표현 없이 명확하게 답합니다.", choosePlan: "요금제 선택",
    faq: [
  ...
  hi: {
    ...
    faqEyebrow: "ज़रूरी बातें", questions: "सवाल", faqIntro: "छोटे अक्षरों और मार्केटिंग के शोर के बिना साफ जवाब।", choosePlan: "प्लान चुनें",
    faq: [
