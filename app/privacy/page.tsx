...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Legal" title="Privacy policy" lead="This policy explains what information Esim.free uses to deliver eSIM products, provide support and keep transactions secure.">
      ...
      <section><h2>9. Complaints</h2><p>Please contact us first so we can investigate a privacy concern. Depending on your location, you may also have the right to complain to your local data-protection authority.</p></section>
      <section><h2>10. Children and updates</h2><p>The service is not directed to children under 18. We may update this policy when our service or legal obligations change; the effective date above shows the current version.</p></section>
    </LegalPage>
  );
}
